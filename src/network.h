...
#define ADD_FRIEND 505
#define DELETE_FRIEND 506
#define ACCEPT_INVITE_FRIEND 507
#define DECLINE_INVITE_FRIEND 508
#define ADD_FRIEND_REQUEST 509

#define NOT_ONLINE 510
#define ACCEPT_FRIEND_REQUEST 511
#define SEND_FRIEND_REQUEST 512
